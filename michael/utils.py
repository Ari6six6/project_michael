...
def build_protocol() -> str:
    ...
    return "\n".join([
        ...
        "",
        "TOOLBOX:",
        "Dynamic tools in tools/ (project-local) and ~/.michael/toolbox/ (global)",
        "auto-load and appear in the tools list. If a required capability is",
        "missing, write it as a Python file there: export TOOL_SCHEMA (OpenAI",
        "function schema dict) and a callable with the same name. It auto-loads",
