...
#   curl -fsSL https://raw.githubusercontent.com/ari6six6/project_michael/claude/michael-wireguard-setup-BenGJ/init.sh | bash
#
...
BRANCH="${BRANCH:-claude/michael-wireguard-setup-BenGJ}"
